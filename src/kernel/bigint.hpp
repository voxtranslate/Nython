...
public:
    ...
    operator long()
    {
        return data_.size()?(long)(data_[0]):0;
    }

    operator unsigned long()
    {
        return data_.size()?(unsigned long)(data_[0]):0;
    }
    ...
    operator int()
    {
        return data_.size()?(int)(data_[0]):0;
    }

    operator unsigned int()
    {
        return data_.size()?(unsigned int)(data_[0]):0;
    }

    operator short()
    {
        return data_.size()?(short)(data_[0]):0;
    }

    operator unsigned short()
    {
        return data_.size()?(unsigned short)(data_[0]):0;
    }

    operator char()
    {
        return data_.size()?(char)(data_[0]):0;
    }

    operator unsigned char()
    {
        return data_.size()?(unsigned char)(data_[0]):0;
    }
    ...
    operator char*()
    {
        return (char*)toString(10, false, true).c_str();
    }
